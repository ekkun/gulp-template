...
const injectReadme = (helpOptions) => {
...
(async () => {
    ...
    fs_1.default.writeFileSync('README.md', injectReadme(helpOptionsString));
    fs_1.default.writeFileSync('src/types/RunOptions.ts', renderRunOptions(cli_options_1.default));
})();
